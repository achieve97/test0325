...
//		System.out.println("첫번째방 : " + numArr1[1]);
		...
		System.out.println("다섯번째방 : " + numArr3[4]);
		...
		// 배열 값을 입력시 타입을 맞춰서 입력!
		char char1[] = {'A','인','천',1};
		String str1[] = {"인덱스0, 인덱스1"};
		boolean bool1[] = { true, true, false, false};
		System.out.println(char1[3]);
		
		//배열의 크기 확인하기
		System.out.println("char[]배열의 크기 : " + char1.length);
		
		
		// for문을 이용해서 배열의 값 확인하기
		for (int i =0; i < char1.length; i++) {
			System.out.println("char1 [" + i + "] = " + char1[i]);
		}
		
		//ex) 국어, 영어, 수학 점수를 저장하고 배열변수에
		//저장된 모든 값의 총점과 평균을 구하여라
